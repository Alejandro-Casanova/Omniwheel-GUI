        ...
        >
          ...
          >
            ...
            <input
              ...
              className={this.props.inputClassName + " outline-none-overide"}
              //className="outline-none-2 border-0 p-0 pr-7 m-0 h-22 grow bg-transparent"
              style={styles.input}
              //style="border: 0px none; padding: 0px 0px 0px 7px; margin: 0px; flex-grow: 100; width: 100%; height: 22px; background: transparent none repeat scroll 0% 0%; outline: currentcolor none 0px; font-size: 15px; color: rgb(240, 191, 129); font-family: monospace;
